...
// Переменные для комнаты «Скороговорки»
let tongueCat = ''; let tongueIndex = 0;
let tongueMediaRecorder = null, tongueAudioChunks = [], tongueRecordedUrl = null;
let tongueMicStream = null, tongueMicTimer = null, tongueMicState = 'idle';
let tongueAnalyser = null, tongueAnalyserCtx = null, tongueAnalyserNode = null, tongueHeardSpeech = false;
const drawData = [
...
'big_small': [
{ big_img: 'bs_ball_big.png', big_sound: 'bs_ball_big.wav', small_img: 'bs_ball_small.png', small_sound: 'bs_ball_small.wav' },
{ big_img: 'bs_car_big.png', big_sound: 'bs_car_big.wav', small_img: 'bs_car_small.png', small_sound: 'bs_car_small.wav' },
{ big_img: 'bs_chair_big.png', big_sound: 'bs_chair_big.wav', small_img: 'bs_chair_small.png', small_sound: 'bs_chair_small.wav' },
{ big_img: 'bs_house_big.png', big_sound: 'bs_house_big.wav', small_img: 'bs_house_small.png', small_sound: 'bs_house_small.wav' },
{ big_img: 'bs_dog.png', big_sound: 'bs_dog.wav', small_img: 'bs_puppy.png', small_sound: 'bs_puppy.wav' },
{ big_img: 'bs_elephant.png', big_sound: 'bs_elephant.wav', small_img: 'bs_mouse.png', small_sound: 'bs_mouse.wav' },
{ big_img: 'bs_tree.png', big_sound: 'bs_tree.wav', small_img: 'bs_leaf.png', small_sound: 'bs_leaf.wav' },
{ big_img: 'bs_ship.png', big_sound: 'bs_ship.wav', small_img: 'bs_boat.png', small_sound: 'bs_boat.wav' },
{ big_img: 'bs_bear.png', big_sound: 'bs_bear.wav', small_img: 'bs_bunny.png', small_sound: 'bs_bunny.wav' },
{ big_img: 'bs_apple.png', big_sound: 'bs_apple.wav', small_img: 'bs_berry.png', small_sound: 'bs_berry.wav' },
{ big_img: 'bs_truck.png', big_sound: 'bs_truck.wav', small_img: 'bs_block.png', small_sound: 'bs_block.wav' },
{ big_img: 'bs_plate.png', big_sound: 'bs_plate.wav', small_img: 'bs_spoon.png', small_sound: 'bs_spoon.wav' }
],
'garden': [
...
{ id: 'run', text: 'Бежит', sound: 'act_run.wav', image: 'act_run.gif' },
{ id: 'swing', text: 'Качается', sound: 'act_swing.wav', image: 'act_swing.gif' },
{ id: 'play', text: 'Играет', sound: 'act_play.wav', image: 'act_play.gif' },
{ id: 'laugh', text: 'Смеётся', sound: 'act_laugh.wav', image: 'act_laugh.gif' },
{ id: 'talk', text: 'Говорит', sound: 'act_talk.wav', image: 'act_talk.gif' },
{ id: 'cry', text: 'Плачет', sound: 'act_cry.wav', image: 'act_cry.gif' },
{ id: 'wash', text: 'Моет ручки', sound: 'act_wash.wav', image: 'act_wash.gif' }
],
'shapes': [
...
'tongue': {
'vegetables': {
title: '🥒 Овощи', bg: '#FFFDE7',
items: [
{ word: 'ОГУРЦЫ',   img: 'tg_ogurcy.png',   sound: 'tg_v_f1.wav' },
{ word: 'КАБАЧОК',  img: 'tg_kabachok.png',  sound: 'tg_v_f2.wav' },
{ word: 'ПОМИДОР',  img: 'tg_pomidor.png',   sound: 'tg_v_f3.wav' },
{ word: 'ЛУК',      img: 'tg_luk.png',       sound: 'tg_v_f4.wav' },
{ word: 'ГОРОХ',    img: 'tg_goroh.png',     sound: 'tg_v_f5.wav' },
{ word: 'МОРКОВКА', img: 'tg_morkovka.png',  sound: 'tg_v_f6.wav' }
]
},
'fruits': {
title: '🍎 Фрукты', bg: '#FFF8E1',
items: [
{ word: 'БАНАН',    img: 'tg_banan.png',   sound: 'tg_f_f1.wav' },
{ word: 'АПЕЛЬСИН', img: 'tg_apelsin.png', sound: 'tg_f_f2.wav' },
{ word: 'ГРУША',    img: 'tg_grusha.png',  sound: 'tg_f_f3.wav' },
{ word: 'СЛИВА',    img: 'tg_sliva.png',   sound: 'tg_f_f4.wav' },
{ word: 'ЛИМОН',    img: 'tg_limon.png',   sound: 'tg_f_f5.wav' },
{ word: 'АРБУЗ',    img: 'tg_arbuz.png',   sound: 'tg_f_f6.wav' }
]
},
'food': {
title: '🍽️ Вкусняшки', bg: '#FFF3E0',
items: [
{ word: 'КАША',   img: 'tg_kasha.png',   sound: 'tg_e_f1.wav' },
{ word: 'МОЛОКО', img: 'tg_moloko.png',  sound: 'tg_e_f2.wav' },
{ word: 'МЁД',    img: 'tg_med.png',     sound: 'tg_e_f3.wav' },
{ word: 'СЫР',    img: 'tg_syr.png',     sound: 'tg_e_f4.wav' },
{ word: 'ЧАЙ',    img: 'tg_chay.png',    sound: 'tg_e_f5.wav' },
{ word: 'ХЛЕБ',   img: 'tg_hleb.png',    sound: 'tg_e_f6.wav' }
]
}
}
};
...
// Скрываем tongue-area, если она есть
const tongueArea = document.getElementById('tongue-area');
if (tongueArea) tongueArea.style.display = 'none';
...
else if (roomId === 'tongue') {
document.getElementById('quizToggle').style.display = 'none';
const area = document.getElementById('tongue-area');
if (area) area.style.display = 'flex';
showTongueMenu();
}
else if (roomId === 'actions') {
...
// Выключаем микрофон, если работала комната скороговорок
if (typeof resetTongueMic === 'function') resetTongueMic();
}
// ==========================================
// ЛОГИКА КОМНАТЫ: СКОРОГОВОРКИ (ПОСЛУШАЙ И ПОВТОРИ)
// ==========================================
function showTongueMenu() {
resetTongueMic();
stopAllAudio();
tongueCat = '';
document.getElementById('tongue-card').style.display = 'none';
document.getElementById('tongue-controls').style.display = 'none';
document.getElementById('tongue-prompt').style.display = 'none';
document.getElementById('tongue-back-btn').style.display = 'none';
document.querySelectorAll('#tongue-area .nav-btn').forEach(b => b.style.display = 'none');

const menu = document.getElementById('tongue-menu');
...
playSound('tongue_intro.wav');
}

function setupTongueCard() {
resetTongueMic();
stopAllAudio();
const catData = roomsData['tongue'][tongueCat];
if (tongueIndex >= catData.items.length) tongueIndex = 0;
if (tongueIndex < 0) tongueIndex = catData.items.length - 1;
const item = catData.items[tongueIndex];

document.getElementById('tongue-menu').style.display = 'none';
document.getElementById('tongue-back-btn').style.display = 'block';
document.getElementById('tongue-card').style.display = 'block';
document.getElementById('tongue-controls').style.display = 'flex';
document.getElementById('tongue-prompt').style.display = 'none';
document.querySelectorAll('#tongue-area .nav-btn').forEach(b => b.style.display = 'flex');

document.getElementById('tongue-area').style.background = catData.bg;
document.getElementById('tongue-img').src = item.img;
document.getElementById('tongue-word').innerText = item.word;

playCurrentTongue();
}

function playCurrentTongue() {
if (!tongueCat) return;
safeVkSend("VKWebAppTapticImpactOccurred", {"style": "light"}).catch(() => {});
const item = roomsData['tongue'][tongueCat].items[tongueIndex];
document.getElementById('tongue-prompt').style.display = 'none';
stopAllAudio();
...
document.getElementById('tongue-prompt').style.display = 'block';
};
audio.play().catch(e => console.log(e));
}

// ⬅️➡️ Листание карточек
function prevTongue() {
safeVkSend("VKWebAppTapticImpactOccurred", {"style": "light"}).catch(() => {});
tongueIndex--;
setupTongueCard();
...
function showTongueStar() {
const star = document.getElementById('tongue-star');
star.style.display = 'block';
setTimeout(() => { star.style.display = 'none'; }, 2200);
}

// ==========================================
// МИКРОФОН: ЗАПИСЬ + ПРОСЛУШИВАНИЕ (ДО 15 СЕК)
// ==========================================
function startTongueMic() {
safeVkSend("VKWebAppTapticImpactOccurred", {"style": "medium"}).catch(() => {});

if (tongueMicState === 'recording') { stopTongueRecording(); return; }
if (tongueMicState === 'recorded') { playTongueRecording(); return; }
if (typeof MediaRecorder === 'undefined') { playSound('wrong.wav'); return; }

stopAllAudio();
playSound('tg_mic_on.wav'); // «Утя слушает! Скажи громко!»

navigator.mediaDevices.getUserMedia({ audio: true, video: false })
.then(stream => {
tongueMicStream = stream;
tongueHeardSpeech = false;

tongueMediaRecorder = new MediaRecorder(stream);
tongueAudioChunks = [];
tongueMediaRecorder.ondataavailable = e => { if (e.data.size > 0) tongueAudioChunks.push(e.data); };
tongueMediaRecorder.onstop = handleTongueRecorded;

// Следим за громкостью: говорил ли ребёнок?
tongueAnalyserCtx = new (window.AudioContext || window.webkitAudioContext)();
tongueAnalyser = tongueAnalyserCtx.createAnalyser();
const src = tongueAnalyserCtx.createMediaStreamSource(stream);
tongueAnalyserNode = tongueAnalyserCtx.createScriptProcessor(2048, 1, 1);
tongueAnalyser.fftSize = 1024;
src.connect(tongueAnalyser);
tongueAnalyser.connect(tongueAnalyserNode);
tongueAnalyserNode.connect(tongueAnalyserCtx.destination);
tongueAnalyserNode.onaudioprocess = () => {
const arr = new Uint8Array(tongueAnalyser.frequencyBinCount);
tongueAnalyser.getByteFrequencyData(arr);
let sum = 0;
for (let i = 0; i < arr.length; i++) sum += arr[i];
if (sum / arr.length > 20) tongueHeardSpeech = true;
};

tongueMediaRecorder.start();
tongueMicState = 'recording';
updateTongueMicBtn();
tongueMicTimer = setTimeout(() => stopTongueRecording(), 15000); // макс 15 сек
})
.catch(() => { playSound('wrong.wav'); });
}

function handleTongueRecorded() {
if (tongueMicStream) { tongueMicStream.getTracks().forEach(t => t.stop()); tongueMicStream = null; }
if (tongueAnalyserCtx && tongueAnalyserCtx.state !== 'closed') tongueAnalyserCtx.close().catch(() => {});

const mime = (tongueMediaRecorder && tongueMediaRecorder.mimeType) || 'audio/webm';
const blob = new Blob(tongueAudioChunks, { type: mime });
if (tongueRecordedUrl) URL.revokeObjectURL(tongueRecordedUrl);
tongueRecordedUrl = URL.createObjectURL(blob);
tongueMicState = 'recorded';
updateTongueMicBtn();

showTongueStar();
playSound(tongueHeardSpeech ? 'tg_praise' + (Math.floor(Math.random() * 3) + 1) + '.wav' : 'tg_quiet.wav');
}

function stopTongueRecording() {
clearTimeout(tongueMicTimer);
if (tongueMediaRecorder && tongueMediaRecorder.state === 'recording') {
tongueMediaRecorder.stop();
}
}

function playTongueRecording() {
if (!tongueRecordedUrl) return;
stopAllAudio();
safeVkSend("VKWebAppTapticImpactOccurred", {"style": "light"}).catch(() => {});
const audio = new Audio(tongueRecordedUrl);
activeAudios.push(audio);
audio.onended = () => {
activeAudios = activeAudios.filter(a => a !== audio);
tongueMicState = 'idle';
...
function resetTongueMic() {
clearTimeout(tongueMicTimer);
if (tongueMediaRecorder && tongueMediaRecorder.state === 'recording') {
tongueMediaRecorder.onstop = null;
try { tongueMediaRecorder.stop(); } catch(e) {}
}
tongueMediaRecorder = null;
tongueAudioChunks = [];
if (tongueMicStream) { tongueMicStream.getTracks().forEach(t => t.stop()); tongueMicStream = null; }
if (tongueAnalyserCtx && tongueAnalyserCtx.state !== 'closed') tongueAnalyserCtx.close().catch(() => {});
tongueAnalyserCtx = null;
if (tongueRecordedUrl) { URL.revokeObjectURL(tongueRecordedUrl); tongueRecordedUrl = null; }
tongueMicState = 'idle';
updateTongueMicBtn();
}
